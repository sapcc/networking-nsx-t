...
from com.vmware.nsx_client import LogicalSwitches, TransportZones, LogicalPorts, NsGroups, SwitchingProfiles, IpSets
...
from com.vmware.nsx.model_client import QosSwitchingProfile, IpDiscoverySwitchingProfile, SpoofGuardSwitchingProfile
...
class NetworkTest(testtools.TestCase):
    ...
    def test_create_logical_switch(self):
        sw_name = self.uuid
        tz_id = NetworkTest.TRANSPORT_ZONE_ID
