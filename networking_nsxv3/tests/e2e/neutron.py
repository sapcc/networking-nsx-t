...
class CustomNeutronClient(client.Client):
    ...
    def show_address_group(self, address_group, **_params):
        """Fetches information of a certain address group."""
        return self.get(self.address_group_path % address_group, params=_params)
